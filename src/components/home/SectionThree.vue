<template>
  <div id="pinContainer" class="content-sections">
    ...
    <div id="sec2" class="panel two">
      <StTwo />
    </div>

    <div id="sec3" class="panel three">
      <StThree />
    </div>

    <div id="sec4" class="panel four">
      <StFour />
    </div>
    <div id="panelRocket" class="panel rocket">
      <div id="rocket"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    let rocket = bodymovin.loadAnimation({
      animationData: {
        "v": "5.7.4",
        "fr": 29.9700012207031,
        "ip": 0,
      ...
      name: "rocket", // Name for future reference. Optional.
    });
    var controller = new ScrollMagic.Controller();

    new ScrollMagic.Scene({ triggerElement: "#sec2" })
      .setClassToggle("#panelRocket", "rocket2") // add class toggle
      .addTo(controller);

    new ScrollMagic.Scene({ triggerElement: "#sec3" })
      .setClassToggle("#panelRocket", "rocket3") // add class toggle
      .addTo(controller);

    new ScrollMagic.Scene({ triggerElement: "#sec4" })
      .setClassToggle("#panelRocket", "rocket4") // add class toggle
      .addTo(controller);
