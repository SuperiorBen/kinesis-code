const miscellaneous2 = function () {
    ...
    let phone = bodymovin.loadAnimation({
        animationData: {
            "v": "5.5.8",
            "fr": 30,
            "ip": 0,
            ...
            "w": 936,
            "h": 936,
            "nm": "Anim_NotifCelularWalkthrough",
            "ddd": 0,
            "assets": [],
            "layers": [
                {
        ...
        loop: true, // Optional
        autoplay: true, // Optional
        name: "phone", // Name for future reference. Optional.
    });
};
